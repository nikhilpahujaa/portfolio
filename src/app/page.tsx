      ...
      <AnimateIn variant="fadeUp" delay={0.7}>
        <section className="mb-4">
          <AnimateIn variant="reveal" delay={0.8}>
            <h2 className="text-lg font-medium tracking-tight mb-4 inline-block">Contact Me</h2>
          </AnimateIn>
...
const experience = [
  ...
  },
  {
    ...
    description: "Built and maintained web scraping tools using Python and Scrapy to collect 30+ Points of Interest (POI) data for location-based services.",
  ...
  },
  {
    ...
    description: "Conducted research on educational technologies, contributing to the development of data-driven reports and improved teaching strategies.",
